...
class UploadNews(MethodView):
    ...
    def post(self, admin_select):
        ...
        if admin_select == "Subir_noticias":
            ...
            return redirect(url_for("uploads_admin.upload_news", admin_select="Subir_noticias"))
    ...
    def handle_news_upload(self):
        try:
            ...
            Exception(f"Error al procesar la not{e}")
    ...
    def handle_exam_upload(self):
        try:
            ...
            if not (title_exam and content_exam and image_exam):
                flash("Todos los campos son obligatorios.")
                return redirect(url_for("uploads_admin.upload_news", admin_select="Subir_examen"))
            ...
            raise Exception(f"Error al procesar el exam{e}")
        return redirect(url_for("uploads_admin.upload_news", admin_select="Subir_examen"))
